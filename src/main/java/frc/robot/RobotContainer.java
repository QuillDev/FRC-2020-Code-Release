...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    //Default command for the swerve subsystem, makes sure we drive when the driver gives input
    swerveDrive.setDefaultCommand( new RunCommand(() -> swerveDrive.drive( -pilotStick.getRawAxis(1), pilotStick.getRawAxis(0), -pilotStick.getRawAxis(4), true), swerveDrive) );
